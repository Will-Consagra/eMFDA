    ...
    for (sigma2 in sigma2s) {
      for (N in Ns) {
        for (nd in Nds) {
          ...
          analysis = array(0, dim=c(length(mb_fit), N, 5))
          ml = 1
          for (mbf in mb_fit) {
            ...
            for (n in 1:N) {
              ...
              analysis[ml, n, 1] = res_n[1]
              analysis[ml, n, 2] = res_n[2]
              analysis[ml, n, 3] = res_n[3]
              analysis[ml, n, 4] = res_n[4]
              analysis[ml, n, 5] = elapsed[1]
            }
            ml = ml + 1
          }
          ## Write analysis 
          ...
          np$save(file.path(DATA_DIR, "analysis_tpb", rt_dir, samp_dir, paste0(replindex, ".npy")), analysis)
        }
      }
    }
  }
